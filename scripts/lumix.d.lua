...
type jolt_module = {
	enableDebugDraw: (jolt_module, boolean) -> (),
	takeSnapshot: (jolt_module) -> (),
}

type jolt_mesh_component =  {
	path: string,
}

type jolt_sphere_component =  {
	radius: number,
}

type jolt_box_component =  {
	half_extents: Vec3,
}

type jolt_body_component =  {
	speed: number,
	active: boolean,
	descrete_motion: boolean,
	friction: number,
	restitution: number,
	...
	init: (jolt_body_component) -> (),
	addImpulse: (jolt_body_component, Vec3) -> (),
	addForce: (jolt_body_component, Vec3) -> (),
}
...
export type Entity = {
	...
	jolt_mesh: jolt_mesh_component,
	jolt_sphere: jolt_sphere_component,
	jolt_box: jolt_box_component,
	jolt_body: jolt_body_component,
}
